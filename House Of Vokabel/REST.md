...
- **Uniform Interface** — resources are identified by URLs;
responses return representations (JSON, XML).
- **Cacheable** — responses can be cached to improve performance.
- **Layered System** — clients do not need to know
whether they are talking directly to the server.
...
- SOAP is more common in enterprise and legacy systems
where strict contracts are required.
